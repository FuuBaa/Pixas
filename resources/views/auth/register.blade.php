...
<body>
    ...
    <header class="header">
        <!-- Header Main -->
        <div class="header-main style--three position-relative">
            <div class="container">
                <div class="header-inner position-relative px-0 mt-0 bg-transparent">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <form class="search-form d-none d-sm-block ms-4" action="#">
                                    <div class="form-group">
                                        <button type="submit">
                                            <img src="assets/img/icons/search-gradient.svg" class="svg" alt="">
                                        </button>
                                    ...
                                    <ul class="nav">
                                        <li>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="home-v3.html">Home V3</a>
                                                </li>
                                                <li><a href="home-v4.html">Home V4</a>
                                                </li>
                                        ...
                                        <li class="current-menu-parent">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="current-menu-children"><a href="register.html">Register</a>
                                                </li>
